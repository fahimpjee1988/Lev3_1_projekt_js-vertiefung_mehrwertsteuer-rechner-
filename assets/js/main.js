function berechnen(){
    if(document.getElementById("netto").checked){
        ...
        document.getElementById("mehrwert").innerHTML=
        (Number(document.getElementById("typein").value)-Number((document.getElementById("typein").value)/1.19)).toFixed(2)
    
        }else{
            document.getElementById("mehrwert2").innerHTML=
            Number(document.getElementById("typein").value)/1.07


            document.getElementById("mehrwert").innerHTML=
            ((Number(document.getElementById("typein").value)-Number(document.getElementById("typein").value)/1.07)).toFixed(2)
